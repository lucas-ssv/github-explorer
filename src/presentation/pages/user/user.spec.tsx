...
describe('UserPage', () => {
  test('Should start with initial correct state', async () => {
    ...
    expect(screen.getByTestId('avatar-url')).toHaveProperty('alt', repositoryResultMock.owner.name)
    ...
    expect(screen.getByTestId('stars-count')).toHaveTextContent(String(repositoryResultMock.starsCount))
    expect(screen.getByTestId('forks-count')).toHaveTextContent(String(repositoryResultMock.forksCount))
    expect(screen.getByTestId('issues-count')).toHaveTextContent(String(repositoryResultMock.issuesCount))
  })
})
